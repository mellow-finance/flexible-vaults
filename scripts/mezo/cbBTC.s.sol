...
contract Deploy is DeployAbstractScript {
        ...
        returns (IDeployVaultFactory.SubvaultParams[] memory subvaultParams)
    {
        ...
        {
            subvaultParams[0].assets = ArraysLibrary.makeAddressArray(abi.encode(Constants.mcbBTC));
    ...
    {
        allowedAssets = ArraysLibrary.makeAddressArray(abi.encode(Constants.mcbBTC));
        allowedAssetsPrices = ArraysLibrary.makeUint224Array(abi.encode(1e28));
    }
