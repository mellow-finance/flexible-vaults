    ...
    */
    ...
    function deployMonad() internal {
        ...
        address[] memory assets_ =
            ArraysLibrary.makeAddressArray(abi.encode(Constants.MON, Constants.WMON, Constants.SHMON));
        ...
        VaultConfigurator.InitParams memory initParams = VaultConfigurator.InitParams({
            ...
            shareManagerParams: abi.encode(bytes32(0), "Monad Fastlane Vault", "MFVT"),
            feeManagerVersion: 0,
...

        {
            ...
            reports[2].priceD18 = uint224(IERC4626(address(Constants.SHMON)).convertToAssets(1 ether));
