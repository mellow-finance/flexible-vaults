...
contract Deploy is Script, Test {
    ...
    address[] assets_ = ArraysLibrary.makeAddressArray(
        abi.encode(Constants.USDT0, Constants.USDE, Constants.SUSDE, Constants.SYRUP_USDT, Constants.WXPL)
    );
    ...
    function _updatePermissions() internal {
        _update(
            0x4E2126de8129f5cb650D86C3E730FEF29D794644,
            0x1a3696ddad264758b91f65832b8e5b7dfeafe75fc3d83dee4e60442b846a4dfd
        );
        _update(
            0xde803287368e47D2aF700Db27afF61a8DeC89cE1,
            0xdbb2dacfd1afffd089959adb2710f4f903630a5e6458e37431c67532b020b08a
        );
        _update(
            0x343A2d6fCEF788596Cb67c8687f1d14Ef6F4664A,
            0x06b82fe970a53136c050fb0d1cd63a66d985e1947c99463e04a6fc3c5b90e295
        );
    }
    ...
    function run() external {
        ...
        vault.feeManager().setBaseAsset(address(vault), Constants.USDT0);
    ...
    function _deploySwapModule(address subvault) internal returns (address) {
        ...
        address[5] memory lidoLeverage =
            [Constants.WXPL, Constants.USDT0, Constants.SUSDE, Constants.USDE, Constants.SYRUP_USDT];
