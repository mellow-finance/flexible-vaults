...
import "../../src/utils/GGVMigratorV2.sol";
...
contract Deploy is Script, Test {
    ...
    function run() external {
        ...
        GGVMigratorV2 migrator = new GGVMigratorV2(curator);
        ...
        migrator.migrate(0.175 ether, 20000 ether, 19000 ether, 1e5);

        migrator.migrate(0.175 ether, 19000 ether, 18000 ether, 1e5);

        migrator.migrate(0.175 ether, 18000 ether, 17000 ether, 3e5);

        migrator.migrate(0.175 ether, 17000 ether, 12000 ether, 1e6);
