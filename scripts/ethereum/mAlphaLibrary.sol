...
library mAlphaLibrary2 {
    ...
    {
        /*
             0. IERC20(USDC).approve(SUB_RED_MANAGEMENT, ...)
             1. IERC20(uMINT).approve(SUB_RED_MANAGEMENT, ...)
             2. IERC20(uMINT).approve(TERMMAX_ROUTER, ...)
             3. IERC20(USDU).approve(TERMMAX_ROUTER, ...)
             4. IERC20(USDU).approve(CURVE_POOL, ...)
             5. IERC20(USDC).approve(CURVE_POOL, ...)
